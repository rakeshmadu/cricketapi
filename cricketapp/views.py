...
def post_fav(request):
    ...
    cursor=collection.insert({"player_id" : request.data['player_id'], 
    "player_name" :request.data['player_name'],"dob":request.data["$datetime"],
    "batting_hand":request.data['batting_hand'],
    "bowling_skill":request.data['bowling_skill'],
    "country":request.data["country"],
    "is_umpire":request.data["is_umpire"],"is_keeper":request.data["is_keeper"],"is_captain":request.data["is_captain"]})
